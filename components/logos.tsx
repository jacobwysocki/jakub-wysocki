...
/**
 * Znaki serwisów: Behance, Stack Overflow, GitHub, LinkedIn. W odróżnieniu
 * od marek wyżej to inline SVG, nie <img>: ikony kontaktu zmieniają kolor
 * razem z przyciskiem na hover, a `fill="currentColor"` działa tylko wtedy,
 * gdy SVG jest w dokumencie.
 *
 ...
 *
 * GitHub i LinkedIn były wcześniej brane z lucide. lucide usunęło znaki marek
 * w 1.0 — nie jest właścicielem tych znaków towarowych, więc `Github`
 * i `Linkedin` nie wrócą. Trzymanie lucide na 0.469 tylko dla dwóch logotypów
 * blokowałoby wszystkie pozostałe ikony, więc znaki są tutaj, tam gdzie już
 * mieszkają Behance i Stack Overflow — i przy okazji cała czwórka wygląda
 * teraz spójnie, bo wszystkie są wypełnione.
 */
type BrandIconProps = {
  size?: number | string;
